...
import uz.algorithmgateway.supplier.databinding.ItemProductTableBinding
import uz.algorithmgateway.supplier.productList.InterfaceProductClick

class AdapterPurchaseProductList(
    private val context: Context,
    private val adapterOnClick: InterfaceProductClick
) : RecyclerView.Adapter<AdapterPurchaseProductList.VH>() {
